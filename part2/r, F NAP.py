...
from tensorflow.keras.optimizers.legacy import Ftrl
import itertools
...
class NAP:
    def __init__(self, tss_train_file=None, tss_test_file=None, severity_scores=None, options=None):
        ...
        if tss_train_file is not None and tss_test_file is not None:
            ...
            self.model.compile(loss='categorical_crossentropy', optimizer=Ftrl(), metrics=['accuracy'])  # , metrics.Precision, metrics.Recall])
